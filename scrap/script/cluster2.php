...
<html lang="en">
    <head>
        ...
        <body>
            <div class="flex-item">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" data-floor="e2" id="cluster-36" role="tabpanel">
                        <div class="map-container" data-floor="e2" data-image="https://cdn.intra.42.fr/cluster/image/36/bg_e2.svg"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 651 920" style="enable-background:new 0 0 651 907;" xml:space="preserve">
                            <style type="text/css">
                                .st0{fill:#CCCCCC;}
        ...
        <text transform="matrix(1 0 0 1 5 50)" class="st0 st1 st2">E2</text>
        <g>
        <?php 
        $all = data();
        $img = "";
        ...
        endforeach;
            ...
            for ($i = 13; $i >= 1 ; $i--)
            {
                ...
                for ($j = 12 ; $j >= 7; $j--)
                {
                    ...
                    $img = $pairkey["e2r".$i."p".$j];
                    echo '<rect id="e2r'.$i.'p'.$j.'" x="'.$x.'" y="'.$y.'" height="45" width="34"></rect><image preserveAspectRatio="xMidYMid slice" id="e2r13p12" x="'.$x.'" y="'.$y.'" height="45" width="34" xlink:href="'.$img.'"></image>';
                    if ($y % 2 == 0)
                    {
                        $y -= 15;
                    }
